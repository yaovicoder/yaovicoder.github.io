...
janin.currency = {
    ...
    useCurrency: function (index) {
        ...
        if (document.getElementById("coinLogoImg")) {
        ...
        // Update i18n link
        // var elements = document.querySelectorAll('input[id^="culture"]');
       ...
       // document.getElementById("culturezh").href = "?culture=zh&currency=" + janin.currency.name().toLowerCase();
        ...
        if(document.getElementById("bulktextarea")){
            document.getElementById("bulktextarea").value = "";
        }
        if(document.getElementById("suppliedPrivateKey")){
...
janin.currencies = [
    ...
    janin.currency.createCurrency("BitcoinZero", 0x4b, 0xd2, "8", "Y", "XL9TU9M8m8EmF9Eux5iBdh3U3Toq2ts2Zr"),
];