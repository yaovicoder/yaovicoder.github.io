// change language
if (document.getElementById("culturemenu")) {
...
// if chekkey page load detailwallet
if(document.getElementById("load-check")){
    ninja.wallets.detailwallet.open();
...
// change currency
var currency = ninja.getQueryString()["currency"] || "bitcoinzero";
...
if (document.getElementById("siteTitle") && ninja.getQueryString()["currency"] == null) {
...
if (document.getElementById("supportedcurrencies")) {
...
if (document.getElementById("donateqrcode")) {
