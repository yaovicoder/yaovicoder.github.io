...
hf("//web.archive.org/web/20181010054449/https://static.doubleclick.net/instream/ad_status.js",a);uf.push(qf(function(){vf||"google_ad_status"in window||(of("//web.archive.org/web/20181010054449/https://static.doubleclick.net/instream/ad_status.js",a),O("DCLKSTAT",3))},5E3))}}
...
b=Ce("//web.archive.org/web/20181010054449/https://googleads.g.doubleclick.net/pagead/id",a)}),function(a){a instanceof Ed&&b.abort();
return Bd(a)})}
...
G.brdim=g.join();Ha=(G.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Ga.visibilityState||Ga.webkitVisibilityState||Ga.mozVisibilityState||""]||0,G.wgl=!!B.WebGLRenderingContext,G);for(var ge in Ha)b[ge]=Ha[ge];b.bid=a;b.bsq=Gi++;Ie("//web.archive.org/web/20181010054449/https://www.youtube.com/ad_data_204",{xa:!1,C:b,withCredentials:!0})},function(){}),T(Fi,18E5)}catch(b){R(b)}}}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&Af.dispose();a=0;for(var b=uf.length;a<b;a++)tf(uf[a]);uf.length=0;nf("//web.archive.org/web/20181010054449/https://static.doubleclick.net/instream/ad_status.js");vf=!1;O("DCLKSTAT",0);cd(Ni,Mi);if(a=Li)a.removeEventListener("onScreenChanged",Qi),a.removeEventListener("onLogClientVeCreated",Pi),a.removeEventListener("onLogServerVeCreated",Ri),a.removeEventListener("onLogVeClicked",Si),a.removeEventListener("onLogVesShown",Ti),a.removeEventListener("onReady",Ui),a.destroy();Oi=
{}});
...
/*
     FILE ARCHIVED ON 05:44:49 Oct 10, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:02:02 Dec 12, 2018.
...
/*
playback timings (ms):
  LoadShardBlock: 815.417 (3)
  esindex: 0.01
  captures_list: 874.916
  CDXLines.iter: 16.268 (3)
  PetaboxLoader3.datanode: 895.717 (5)
  exclusion.robots: 0.231
  exclusion.robots.policy: 0.215
  RedisCDXSource: 5.643
  PetaboxLoader3.resolve: 78.64 (3)
  load_resource: 641.797
*/