...
function updateRecent(data) {
    ...
    if (lastRecentData != jsData) {
        ...
        $('#difficulty').html(fmtDiff(lastDiff) + ' <span class="far fa-arrow-alt-circle-' + diffDir + '"></span>');
...
function getRecent() {
    $.get("https://cors-anywhere.herokuapp.com/https://chainz.cryptoid.info/explorer/index.data.dws?" + coinParam + "&n=" + nbRecent, updateRecent).fail(function () {
        scheduleGetRecent(15000)
    });
